 ...
 */
final class Version20231108190206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE images (id INT AUTO_INCREMENT NOT NULL, voitures_occasions_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, INDEX IDX_E01FBE6A5B12944E (voitures_occasions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE voitures_occasions (id INT AUTO_INCREMENT NOT NULL, voitures_ocassions_marques_id INT DEFAULT NULL, photo LONGBLOB NOT NULL, prix INT NOT NULL, annee DATE NOT NULL, kilometrage INT NOT NULL, carburant VARCHAR(50) NOT NULL, boite_de_vitesse VARCHAR(50) NOT NULL, INDEX IDX_7BD5F28B8877BDB2 (voitures_ocassions_marques_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

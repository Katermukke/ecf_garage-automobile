...
class AvisFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $avi1->setCommentaire('Tres bonne experience, je pense que tout dépend du personnel...');
        ...
        $avi2->setCommentaire('Travail bien fait mais 3h pour une révision...');
        ...
        $avi3->setCommentaire('Espace de vente propre, lumineux, bien agencé...');
